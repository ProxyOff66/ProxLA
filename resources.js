...
(function () {
    ...
    if (!TAFFY) {
        ...
        r.extend("filter", function () {
            var y = TAFFY.mergeObj(this.context(), {run: null}), x = [];
            c(y.q, function (z) {
                x.push(z)
            });
            y.q = x;
        ...
        r.extend("start", function (z) {
            ...
            if (y.run && y.sort && !y.limit) {
                ...
                y = TAFFY.mergeObj(this.context(), {run: null, start: z})
            }
            return this.getroot(y)
        });
            ...
            E = {
                dm: function (J) {
                    ...
                    if (z.cacheSize) {
                        ...
                        if (P === "") {
                            P = a(T.mergeObj(L, {q: false, run: false, sort: false}))
                        }
                    }
...
/*
     ...
     INTERNET ARCHIVE ON 14:55:59 Aug 27, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 73.062
  LoadShardBlock: 338.954 (3)
  PetaboxLoader3.datanode: 291.185 (4)
  load_resource: 535.315
  PetaboxLoader3.resolve: 497.282
*/